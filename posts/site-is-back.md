...
- Figure out what to do with my mailserver. Currently it's running on [mailcow](https://github.com/mailcow/mailcow-dockerized) which is great but I'm wondering if it's overkill for what my family needs also it's a bit of a pig and uses a lot of resources
